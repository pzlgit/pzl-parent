package com.pzl.program.others.algorith;

import com.pzl.program.assistant.util.SysUtil;
import com.pzl.program.toolkit.constant.BaseConstant;
...
public class StringImpl {
    ...
    public static String simpleEncoding(String str) {
        try {
            ...
            if (str.equals(new String(bs, BaseConstant.UTF_8))) {
                return BaseConstant.UTF_8;
            }
            if (str.equals(new String(bs, BaseConstant.GBK))) {
                return BaseConstant.GBK;
            }
            if (str.equals(new String(bs, BaseConstant.ISO_8859_1))) {
                return BaseConstant.ISO_8859_1;
            }
